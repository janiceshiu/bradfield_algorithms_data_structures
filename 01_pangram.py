class Pangram:
  ...
  This should be an easy problem, so it’s a good excuse to practice Polya’s
  method. So, please find at least three different strategies for solving
  this problem, proceeding through Polya’s method each time. In each case,
  make a note of how you came to that.
  """
